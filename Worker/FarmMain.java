...
public class FarmMain {
	...
	public static void initialise() throws Exception {
		...
		InetAddress serveerIp = InetAddress.getByName("server");
		...
		/*
		 * Socket tempsocket = new Socket(serveerIp,2222); MyCommunicationSocket temps =
		 * new MyCommunicationSocket(tempsocket);
		 * temps.sendMessage(Integer.toString(myport));
		 * 
		 * if(tempsocket.isConnected()) { tempsocket.close(); } else {
		 ...
		 * /*System.out.print("This farm's IP: "); myipaddress =
		 * InetAddress.getByName(bufferedReader.readLine());
		 */
